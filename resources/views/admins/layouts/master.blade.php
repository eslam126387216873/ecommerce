...
<body class="theme-red">
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <li>
                ...
                <ul class="ml-menu">
                    ...
                    <li>
                        <a class="{{Request::is('*/admin/index_color') ? 'active' : ''}}" href="{{route('index_color')}}">@lang('site.color_page')</a>
                    </li>

                    <li>
                        <a class="{{Request::is('*/admin/index_size') ? 'active' : ''}}" href="{{route('index_size')}}">@lang('site.size_page')</a>
                    </li>
                </ul>
            </li>
        ...
        <ul class="ml-menu">
            <li>
                <a href="{{route('index_product')}}">@lang('site.product_page')</a>
            </li>
